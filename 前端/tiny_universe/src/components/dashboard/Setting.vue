<template>
  <div class="setting">
    <el-icon @click="drawer=true" class="setting_icon" :color="color.text_color"><Setting /></el-icon>
    <el-drawer v-model="drawer" :size="300">
      <div>
        <p>风格：</p>
        <el-space direction="vertical">
          <el-space :size="40">
            <svg t="1718716275722" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4785" width="100" height="100"><path d="M0 0m102.4 0l819.2 0q102.4 0 102.4 102.4l0 819.2q0 102.4-102.4 102.4l-819.2 0q-102.4 0-102.4-102.4l0-819.2q0-102.4 102.4-102.4Z" fill="#000000" p-id="4786"></path></svg>
            <svg t="1718716275722" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4785" width="100" height="100"><path d="M0 0m102.4 0l819.2 0q102.4 0 102.4 102.4l0 819.2q0 102.4-102.4 102.4l-819.2 0q-102.4 0-102.4-102.4l0-819.2q0-102.4 102.4-102.4Z" fill="#ffffff" p-id="4786"></path></svg>
          </el-space>
